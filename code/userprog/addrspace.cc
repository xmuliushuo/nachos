...
// this defination has moved to threads/system.cc
...
bool AddrSpace::Setup(OpenFile *executable)
{
    NoffHeader noffH;
    unsigned int i, size;
...
// first, set up the translation 
    ...
    for (i = 0; i < numPages; i++) {
        ...
        if ((pageTable[i].physicalPage = mm->AllocNewPage()) == -1) {
            printf("alloc physical page error\n");
            return FALSE;
        }
